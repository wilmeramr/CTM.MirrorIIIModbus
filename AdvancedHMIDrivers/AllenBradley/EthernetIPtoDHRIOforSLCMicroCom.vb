...
Public Class EthernetIPtoDHRIOforSLCMicroCom
    Inherits MfgControl.AdvancedHMI.Drivers.AllenBradley.PCCC.EthernetIPtoDHRIOforSLCMicroPLC5
...
#Region "Constructor"
    ...
    Protected Overrides Sub Dispose(ByVal disposing As Boolean) 'Implements IDisposable.Dispose
        If disposing Then
            SyncLock Me
...
#Region "Properties"
    ...
    Public Overrides Property IsPLC5 As Boolean
        Get
            Return MyBase.IsPLC5
        End Get
